...
ggplot(data = data1)+
  ...
  geom_vline(aes(xintercept = mean(as.numeric(V1))), color ="blue")+
  geom_vline(aes(xintercept = mean(as.numeric(V2))), color = "red")+
  geom_vline(aes(xintercept = mean(as.numeric(V3))),color = "green")
ggplot(data = data1)+
  geom_density(aes(y = as.numeric(V1)), fill ="blue", alpha=0.3, color="black")+
  geom_density(aes(y = as.numeric(V2)), fill = "green", alpha=0.3)+
  geom_density(aes(y = as.numeric(V3)),fill = "red", alpha=0.3)
ggplot(data = data1)+
  geom_boxplot(aes(y = as.numeric(V1)), fill ="red", alpha=0.3, color="black")
ggplot(data = data1)+
  geom_boxplot(aes(y = as.numeric(V2)), fill = "red", alpha=0.3)
ggplot(data = data1)+
  geom_boxplot(aes(y = as.numeric(V3)),fill = "red", alpha=0.3)
ggplot(data = data1, aes(x=""))+
  geom_violin(aes(y = as.numeric(V1)), fill ="blue", alpha=0.3, color="black")+
  geom_violin(aes(y = as.numeric(V2)), fill = "green", alpha=0.3)+
  geom_violin(aes(y = as.numeric(V3)),fill = "red", alpha=0.3)
ggplot(data = data1)+
  geom_bar(aes(x = as.numeric(V1)), fill ="blue", alpha=0.3, color="black")+
  geom_bar(aes(x = as.numeric(V2)), fill = "green", alpha=0.3)+
  geom_bar(aes(x = as.numeric(V3)),fill = "red", alpha=0.3)
